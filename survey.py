...
def profile():
    ...
    return render_template("survey.html", fullname=fullname, age=age, occupation=occupation, salary=salary, education=education, state=state, city_type=city_type, garden=garden, tv=tv )
